...
import HFPickerAndroid from './HFPickerAndroid';

let Picker = Platform.OS === 'ios' ? PickerIOS : HFPickerAndroid;
...
export default class HFPicker extends Component {
				...
				<View style={[styles.pickerBox, this.state.style]}>
					<View style={[styles.pickerToolbar, this.state.pickerToolBarStyle, {width: this.state.style.width || width}]}>
						<View style={styles.pickerCancelBtn}>
							<Text style={[styles.pickerCancelBtnText, this.state.pickerBtnStyle]}
						...
						<Text style={[styles.pickerTitle, this.state.pickerTitleStyle]} numberOfLines={1}>
							{[this.state.pickerTitle,this.state.pickerTitleText]}
						</Text>
