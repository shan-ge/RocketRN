...
class HFRowBox extends Component {
                        ...
                        <View style={{flex:1,flexDirection:'column'}}>
                            <View style={styles.innerRow}>
                                {RenderIf(innerViewType == 'text')(
                                    <HFText
                                        numberOfLines={1}
                                        style={[styles.input,{color:(this.state.value == null||this.state.value == ''||this.state.value == '未完善')?HFConfiguration.placeholderColor:HFConfiguration.textInputFontColor}]}
                                ...
                                {RenderIf(innerViewType == 'image' && (this.state.data == null || this.state.data.length == 0))(
                                    <HFText
                                        numberOfLines={1}
                                        style={[styles.input,{color:HFConfiguration.placeholderColor}]}
                        ...
                        <View style={styles.innerRow}>
                            {RenderIf(innerViewType == 'textInput')(
                                <HFTextInput
                                    ...
                                    inputStyle={{fontSize:HFConfiguration.textFontSize[HFConfiguration.dpiIndex],paddingLeft:0}}
...
const styles = StyleSheet.create({
    outerRow: {
        ...
        backgroundColor: '#fff',
        borderWidth: 1,
        borderColor: HFConfiguration.separatorLineColor,
        borderRadius: 5,
